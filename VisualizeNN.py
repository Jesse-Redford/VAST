...
class Layer():
    def __init__(self, network, number_of_neurons, number_of_neurons_in_widest_layer):
        self.vertical_distance_between_layers =  20 #6  # make sure this matches value in draw function NNclass
...
class NeuralNetwork():
    def __init__(self, number_of_neurons_in_widest_layer, model_name = 'model',path=''):
        self.path = path
    ...
    def draw(self, weights_list=None, model_name = 'model', path=''):
        ...
        vertical_distance_between_layers = 20 #6
        ...
        #path = r'C:/Users/Jesse/Desktop/Snakebot_Backup-3-30-2020/visualize-neural-network-master/NN_Images/'        
        
        pyplot.axis('scaled')
        pyplot.axis('off')
        #pyplot.title( 'Neural Network architecture', fontsize=15 )
        pyplot.title(self.model_name, fontsize=15 )
...
class DrawNN():
   ...
   # def __init__( self, neural_network, weights_list=None ):
    def __init__( self, neural_network, weights_list=None, model_name = 'Neural Network Architecture', path = ''):
    ...
    def draw( self ):
        ...
        network = NeuralNetwork( widest_layer, model_name, path )
